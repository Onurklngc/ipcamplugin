...
if (process.env.TARGET) {
  ...
  // Add java files where you want to add R.java imports in the following array
    ...
    var filestoreplace = [
        "platforms/android/src/com/edimax/edilife/MainFrame.java",
        "platforms/android/src/com/edimax/edilife/MainActivity.java"
    ];
    filestoreplace.forEach(function(val, index, array) {
        if (fs.existsSync(val)) {
          ...
          var packageName = configobj.installed_plugins["com.edimax.edilife"]["PACKAGE_NAME"];
          console.log("With the package name: "+packageName);
          console.log("Adding import for R.java");
            replace_string_in_file(val,"package com.edimax.edilife;","package com.edimax.edilife;\n\nimport "+packageName+".R;");
			replace_string_in_file(val,"com.edimax.edilife.ipcam.page;","com.edimax.edilife.ipcam.page;\n\nimport "+packageName+".R;");
        } else {
